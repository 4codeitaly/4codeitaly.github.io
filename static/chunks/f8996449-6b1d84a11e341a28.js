"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[244],{6616:function(e,t,r){r.d(t,{ET:function(){return addDoc},IO:function(){return query},JU:function(){return doc},QT:function(){return getDoc},ad:function(){return getFirestore},cf:function(){return onSnapshot},hJ:function(){return collection},oe:function(){return deleteDoc},r7:function(){return updateDoc}});var n,i,s=r(4158),a=r(5856),o=r(2199),l=r(7682),u=r(8596);r(5480);let c="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let E=new SortedMap(DocumentKey.comparator),g=new SortedMap(DocumentKey.comparator);function documentMap(...e){let t=g;for(let r of e)t=t.insert(r.key,r);return t}function __PRIVATE_convertOverlayedDocumentMapToDocumentMap(e){let t=g;return e.forEach((e,r)=>t=t.insert(e,r.overlayedDocument)),t}function __PRIVATE_newDocumentKeyMap(){return new ObjectMap(e=>e.toString(),(e,t)=>e.isEqual(t))}let T=new SortedMap(DocumentKey.comparator),I=new SortedSet(DocumentKey.comparator);function __PRIVATE_documentKeySet(...e){let t=I;for(let r of e)t=t.add(r);return t}let P=new SortedSet(__PRIVATE_primitiveComparator);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function getDoc(e){e=__PRIVATE_cast(e,DocumentReference);let t=__PRIVATE_cast(e.firestore,Firestore);return(function(e,t,r={}){let n=new __PRIVATE_Deferred;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new __PRIVATE_AsyncObserver({next:s=>{t.enqueueAndForget(()=>__PRIVATE_eventManagerUnlisten(e,a));let o=s.docs.has(r);!o&&s.fromCache?i.reject(new FirestoreError(d.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&n&&"server"===n.source?i.reject(new FirestoreError(d.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new __PRIVATE_QueryListener(__PRIVATE_newQueryForPath(r.path),s,{includeMetadataChanges:!0,Y_:!0});return __PRIVATE_eventManagerListen(e,a)})(await __PRIVATE_getEventManager(e),e.asyncQueue,t,r,n)),n.promise})(ensureFirestoreConfigured(t),e._key).then(r=>__PRIVATE_convertToDocSnapshot(t,e,r))}let __PRIVATE_ExpUserDataWriter=class __PRIVATE_ExpUserDataWriter extends AbstractUserDataWriter{constructor(e){super(),this.firestore=e}convertBytes(e){return new Bytes(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new DocumentReference(this.firestore,null,t)}};function updateDoc(e,t,r,...n){e=__PRIVATE_cast(e,DocumentReference);let i=__PRIVATE_cast(e.firestore,Firestore),s=__PRIVATE_newUserDataReader(i);return executeWrite(i,[("string"==typeof(t=(0,l.m9)(t))||t instanceof FieldPath?function(e,t,r,n,i,s){let a=e.yu(1,t,r),o=[__PRIVATE_fieldPathFromArgument$1(t,n,r)],u=[i];if(s.length%2!=0)throw new FirestoreError(d.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(__PRIVATE_fieldPathFromArgument$1(t,s[e])),u.push(s[e+1]);let c=[],_=ObjectValue.empty();for(let e=o.length-1;e>=0;--e)if(!__PRIVATE_fieldMaskContains(c,o[e])){let t=o[e],r=u[e];r=(0,l.m9)(r);let n=a.Vu(t);if(r instanceof __PRIVATE_DeleteFieldValueImpl)c.push(t);else{let e=__PRIVATE_parseData(r,n);null!=e&&(c.push(t),_.set(t,e))}}let h=new FieldMask(c);return new ParsedUpdateData(_,h,a.fieldTransforms)}(s,"updateDoc",e._key,t,r,n):function(e,t,r,n){let i=e.yu(1,t,r);__PRIVATE_validatePlainObject("Data must be an object, but it was:",i,n);let s=[],a=ObjectValue.empty();forEach(n,(e,n)=>{let o=__PRIVATE_fieldPathFromDotSeparatedString(t,e,r);n=(0,l.m9)(n);let u=i.Vu(o);if(n instanceof __PRIVATE_DeleteFieldValueImpl)s.push(o);else{let e=__PRIVATE_parseData(n,u);null!=e&&(s.push(o),a.set(o,e))}});let o=new FieldMask(s);return new ParsedUpdateData(a,o,i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,Precondition.exists(!0))])}function deleteDoc(e){return executeWrite(__PRIVATE_cast(e.firestore,Firestore),[new __PRIVATE_DeleteMutation(e._key,Precondition.none())])}function addDoc(e,t){var r,n;let i=__PRIVATE_cast(e.firestore,Firestore),s=doc(e),a=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return executeWrite(i,[(function(e,t,r,n,i,s={}){let a,o;let l=e.yu(s.merge||s.mergeFields?2:0,t,r,i);__PRIVATE_validatePlainObject("Data must be an object, but it was:",l,n);let u=__PRIVATE_parseObject(n,l);if(s.merge)a=new FieldMask(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=__PRIVATE_fieldPathFromArgument$1(t,n,r);if(!l.contains(i))throw new FirestoreError(d.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);__PRIVATE_fieldMaskContains(e,i)||e.push(i)}a=new FieldMask(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new ParsedSetData(new ObjectValue(u),a,o)})(__PRIVATE_newUserDataReader(e.firestore),"addDoc",s._key,a,null!==e.converter,{}).toMutation(s._key,Precondition.exists(!1))]).then(()=>s)}function onSnapshot(e,...t){var r,n,i;let s,a,o;e=(0,l.m9)(e);let u={includeMetadataChanges:!1},c=0;"object"!=typeof t[0]||__PRIVATE_isPartialObserver(t[c])||(u=t[c],c++);let _={includeMetadataChanges:u.includeMetadataChanges};if(__PRIVATE_isPartialObserver(t[c])){let e=t[c];t[c]=null===(r=e.next)||void 0===r?void 0:r.bind(e),t[c+1]=null===(n=e.error)||void 0===n?void 0:n.bind(e),t[c+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof DocumentReference)a=__PRIVATE_cast(e.firestore,Firestore),o=__PRIVATE_newQueryForPath(e._key.path),s={next:r=>{t[c]&&t[c](__PRIVATE_convertToDocSnapshot(a,e,r))},error:t[c+1],complete:t[c+2]};else{let r=__PRIVATE_cast(e,Query);a=__PRIVATE_cast(r.firestore,Firestore),o=r._query;let n=new __PRIVATE_ExpUserDataWriter(a);s={next:e=>{t[c]&&t[c](new QuerySnapshot(a,n,r,e))},error:t[c+1],complete:t[c+2]},/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
